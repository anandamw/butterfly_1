    ...
    <div class="main-content">
        ...
        <div class="rs-breadcrumbs breadcrumbs-overlay">
            <div class="breadcrumbs-img">
                <img src="{{ asset('educavo') }}/assets/images/breadcrumbs/breadcumbsejarah.JPG" alt="Breadcrumbs Image">
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
                        <div class="img-part">
                            <img class="" src="{{ asset('educavo') }}/assets/images/about/about2orange.png"
                                alt="About Image">
                        </div>
                    </div>
                    <div class="col-lg-6 pr-70 md-pr-15">
                        <div class="sec-title">
                            ...
                            <div class="bold-text mb-22">Recogizing the need is the primary than we expected Lorem ipsum
                                dolor sit amet, consectetur adipisicing elit. Sint ipsa voluptatibus,</div>
                            <div class="desc">Lorem ipsum dolor sit amet, consectetur adipisic ing elit, sed eius to
                                mod
                                tempors incididunt ut labore et dolore magna this aliqua enims ad minim. Lorem ipsum
                                dolor
                                sit amet, consectetur adipisic ing elit, sed eius to mod tempor. Lorem ipsum dolor sit
                                amet
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row y-bottom">
                        <div class="col-lg-6 pb-50 md-pt-70 md-pb-70">
                            <div class="video-wrap">
                                <a class="popup-videos"
                                    href="{{ asset('educavo') }}/ttps://www.youtube.com/watch?v=atMUy_bPoQI">
                        ...
                        <div class="col-lg-6 pl-62 pt-134 pb-150 md-pt-50 md-pb-50 md-pl-15">
                            <div class="sec-title mb-40 md-mb-20">
                                ...
                                <div class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eius
                                    to
                                    mod tempor incididunt ut labore et dolore magna aliqua. Ut enims ad minim veniam.
                                    Aenean
                                    massa. Cum sociis natoque penatibus et magnis.</div>
                            </div>
                            <div class="btn-part">
                                <a class="readon2 orange" href="{{ asset('educavo') }}/">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row couter-area">
                    <div class="col-md-4 sm-mb-30">
                        <div class="counter-item text-center">
                            <div class="counter-bg">
                                <img src="{{ asset('educavo') }}/assets/images/counter/bg1.png" alt="Counter Image">
                            </div>
                    ...
                    <div class="col-md-4 sm-mb-30">
                        <div class="counter-item text-center">
                            <div class="counter-bg">
                                <img src="{{ asset('educavo') }}/assets/images/counter/bg2.png" alt="Counter Image">
                            </div>
                            <div class="counter-text">
                    ...
                    <div class="col-md-4">
                        <div class="counter-item text-center">
                            <div class="counter-bg">
                                <img src="{{ asset('educavo') }}/assets/images/counter/bg3.png" alt="Counter Image">
                            </div>
                            <div class="counter-text">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 padding-0 md-pl-15 md-pr-15 md-mb-30">
                        <div class="img-part">
                            <img class="" src="{{ asset('educavo') }}/assets/images/about/history.png"
                                alt="About Image">
                        </div>
                        <ul class="nav nav-tabs histort-part" id="myTab" role="tablist">
                            <li class="nav-item tab-btns single-history">
                                <a class="nav-link tab-btn active" id="about-history-tab" data-toggle="tab"
                                    href="{{ asset('educavo') }}/about-history" role="tab" aria-controls="about-history"
                            ...
                            <li class="nav-item tab-btns single-history">
                                <a class="nav-link tab-btn" id="about-mission-tab" data-toggle="tab"
                                    href="{{ asset('educavo') }}/about-mission" role="tab" aria-controls="about-mission"
                            ...
                            <li class="nav-item tab-btns single-history last-item">
                                <a class="nav-link tab-btn" id="about-admin-tab" data-toggle="tab"
                                    href="{{ asset('educavo') }}/about-admin" role="tab" aria-controls="about-admin"
                                    aria-selected="false"><span class="icon-part"><i
                    ...
                    <div class="col-lg-5">
                        <div class="tab-content tabs-content" id="myTabContent">
                            <div class="tab-pane tab fade show active" id="about-history" role="tabpanel"
                                ...
                                <div class="sec-title mb-25">
                                    ...
                                    <div class="desc">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                        blan
                                        ditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas
                                        molestias
                                        excepturi sint occaecati cupiditate non provident, sim ilique sunt in culpa.
                                    </div>
                                </div>
                                <div class="tab-img">
                                    <img class="" src="{{ asset('educavo') }}/assets/images/about/tab1.jpg"
                                        alt="Tab Image">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="about-mission" role="tabpanel"
                                ...
                                <div class="tab-img">
                                    <img class="" src="{{ asset('educavo') }}/assets/images/about/tab2.jpg"
                                        alt="Tab Image">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="about-admin" role="tabpanel"
                                ...
                                <div class="tab-img">
                                    <img class="" src="{{ asset('educavo') }}/assets/images/about/tab3.jpg"
                                        alt="Tab Image">
                                </div>
                            </div>
                        </div>
        ...
        <div id="rs-team" class="rs-team style1 orange-color pt-94 pb-100 md-pt-64 md-pb-70 gray-bg">
            <div class="container">
                ...
                <div class="rs-carousel owl-carousel nav-style2 orange-color" data-loop="true" data-items="3"
                    ...
                    <div class="team-item">
                        <img src="{{ asset('educavo') }}/assets/images/team/1.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="{{ asset('educavo') }}/eam-single.html">Jhon Pedrocas</a>
                            </h4>
                    ...
                    <div class="team-item">
                        <img src="{{ asset('educavo') }}/assets/images/team/2.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="{{ asset('educavo') }}/eam-single.html">Jesika Albenian</a>
                            </h4>
                            <span class="designation">Professor</span>
                            <ul class="social-links">
                                <li><a href="{{ asset('educavo') }}/"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="team-item">
                        <img src="{{ asset('educavo') }}/assets/images/team/3.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="{{ asset('educavo') }}/eam-single.html">Alex Anthony</a></h4>
                            <span class="designation">Professor</span>
                            <ul class="social-links">
                                <li><a href="{{ asset('educavo') }}/"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="{{ asset('educavo') }}/"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="row">
                    <div class="col-lg-5 pr-90 md-pr-15 md-mb-30">
                        <div class="donation-part">
                            <img src="{{ asset('educavo') }}/assets/images/donor/1.jpg" alt="">
                            <h3 class="title mb-10">Donation helps us</h3>
                            <div class="desc mb-38">Lorem ipsum dolor sit amet, consectetur adipisic ing elit, sed eius
                                to
                                mod tempors incididunt ut labore et dolore magna this aliqua enims ad minim.</div>
                            <div class="btn-part">
                                <a class="readon2 orange" href="{{ asset('educavo') }}/">Become a donor</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7 lg-pl-0 ml--15 md-ml-0">
                        <div class="testi-wrap mb-50">
                            <div class="img-part">
                                <img src="{{ asset('educavo') }}/assets/images/testimonial/style2/1.jpg" alt="">
                            </div>
                            <div class="content-part new-content pt-12">
                                <div class="desc">Education is the passport to the future for tomorrow belongs to
                                    those
                                    who prepare for it today</div>
                                <div class="info">
                        ...
                        <div class="testi-wrap">
                            <div class="img-part">
                                <img src="{{ asset('educavo') }}/assets/images/testimonial/style2/2.jpg" alt="">
                            </div>
                            <div class="content-part new-content pt-12">
                                <div class="desc">Education is the passport to the future for tomorrow belongs to
                                    those
            ...
            <div class="container">
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="30"
                    ...
                    <div class="partner-item">
                        <a href="{{ asset('educavo') }}/"><img src="{{ asset('educavo') }}/assets/images/partner/1.png"
                                alt=""></a>
                    </div>
                    <div class="partner-item">
                        <a href="{{ asset('educavo') }}/"><img src="{{ asset('educavo') }}/assets/images/partner/2.png"
                                alt=""></a>
                    </div>
                    <div class="partner-item">
                        <a href="{{ asset('educavo') }}/"><img src="{{ asset('educavo') }}/assets/images/partner/3.png"
                                alt=""></a>
                    </div>
                    <div class="partner-item">
                        <a href="{{ asset('educavo') }}/"><img src="{{ asset('educavo') }}/assets/images/partner/4.png"
                                alt=""></a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="content-part">
                                <div class="sec-title">
                                    <div class="title-icon md-mb-15">
                                        <img src="{{ asset('educavo') }}/assets/images/newsletter.png" alt="images">
                                    </div>
